...
"""
    tangent(polar_curve::L,t::T) where {L<:AbsPolarCurve,T<:Real}
...
"""
function tangent(polar_curve::L,t::T) where {L<:AbsPolarCurve,T<:Real}
...
"""
    tangent(polar_curve::L,ts::AbstractArray) where {L<:AbsPolarCurve}
...
"""
function tangent(polar_curve::L,ts::AbstractArray) where {L<:AbsPolarCurve}
    return [tangent(polar_curve,t) for t in ts]
end

"""
    tangent_2(polar_curve::L,t::T) where {L<:AbsPolarCurve,T<:Real}
...
"""
function tangent_2(polar_curve::L,t::T) where {L<:AbsPolarCurve,T<:Real}
...
"""
    tangent_2(polar_curve::L,ts::AbstractArray) where {L<:AbsPolarCurve}
...
"""
function tangent_2(polar_curve::L,ts::AbstractArray) where {L<:AbsPolarCurve}
