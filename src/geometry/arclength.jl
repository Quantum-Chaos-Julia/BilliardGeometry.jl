...
function construct_arc_length_interpolation(::Type{T},crv::C;q=3.0,p::Int=8,quad_rtol=1e-8,speed_ratio_max=3.0,init_panels::Int=8,nprobe::Int=9,tol_newton=1e-11) where {BC,T<:Real,C<:AbsPolarCurve{BC}}
